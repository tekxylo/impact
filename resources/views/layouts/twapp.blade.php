...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100" x-data="{ open: false, mopen: false }">
            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                    <!-- Mobile menu button-->
                    <button @click="open=true" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-150 ease-in-out" aria-label="Main menu" aria-expanded="false">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <img class="hidden lg:block h-8 w-auto" src="tw-impact.png" alt="Workflow logo" style="margin-top:1px;">
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Rides</a>
                        <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Vehicles</a>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div>
                        ...
                        <img @click="open=true" class="h-8 w-8 rounded-full" src="https://cdn.discordapp.com/attachments/760701188030857223/764164057351061504/20200923_202220.png" alt="">
                        </button>
                    </div>
                    <!--
                    ...
                    -->
                    <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg" @click.away="open = false" x-show="open">
