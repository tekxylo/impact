<div class="card">
            <div class="card-body">
               <center>
                  <h2 style="margin-top:5px;" class="text-primary"><i class="fad fa-home"></i></h2>
                  <p style="padding:0px;margin:0px;"><strong>Dashboard</strong></p>
               </center>
            </div>
         </div>
         <br>
        ...
        <div class="col-sm-3">
            <div class="card" style="height:114px;">
               <div class="card-body">
               <center>
               <img src="https://media.discordapp.net/attachments/756086069275131945/764507706127548466/20200923_202220.png" alt="userprofile" class="img-responsive rounded-circle" style="width:80px;height:80px;">
                              <br>
               </center>
               </div>
            </div>
    ...
    padding-bottom: 0px;
    margin-bottom: 0px;
">3000/10000 OXP</strong><hr style="
